            ...
            <div className='flex flex-col justify-center '>
                <div className=' bg-white'>
                    <header className='p-4 flex justify-between items-center gap-8 mx-16'>
                        ...
                        <div className='flex items-center gap-4 font-bold p-2 me-4 '>
                        <button className='bg-purple-200 font-semibold px-4 py-1 rounded-2xl text-purple1 o' onClick={SignNav}>
                        Sign Up
                            </button>
                            <button className='bg-purple1 font-semibold p-4 py-1 rounded-2xl text-white' onClick={loginNav} >
                                Login
                            </button>
                        </div>
